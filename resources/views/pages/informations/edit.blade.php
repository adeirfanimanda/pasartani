    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                <h2 class="dashboard-title">Edit Informasi Panen</h2>
                <p class="dashboard-subtitle">
                    Edit informasi panen Anda
                </p>
            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="form-control" required>
                                                    <option value="{{ $information->category_id }}">Tidak diganti
                                                        ({{ $information->category->name }})</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="date_tanam" name="date_tanam"
                                                    value="{{ $information->date_tanam }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="date_panen" name="date_panen"
                                                    value="{{ $information->date_panen }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
